...
function setupScene(gltf) {
    ...
    container.appendChild(renderer.domElement); // rendere.domElement es el canvas

    // Camera setup
    const camera = new THREE.PerspectiveCamera(
      45, container.clientWidth / container.clientHeight); // Esto debe ser el ángulo de visión
    camera.position.set(0.2, 0.5, 1); // Esto debe ser la posición de la cámara
    ...
    controls.target = new THREE.Vector3(0, 0.75, 0); // Esto debe ser la posición del avatar
    controls.update(); // Actualizar la cámara
